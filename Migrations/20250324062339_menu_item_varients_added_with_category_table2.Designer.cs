...
namespace foodOrderingApp.Migrations
{
    ...
    [Migration("20250324062339_menu_item_varients_added_with_category_table2")]
    partial class menu_item_varients_added_with_category_table2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("foodOrderingApp.models.Menu", b =>
                {
                    b.HasOne("foodOrderingApp.models.Restaurant", "Restaurant")
                        .WithOne("Menu")
                        .HasForeignKey("foodOrderingApp.models.Menu", "RestaurantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("foodOrderingApp.models.MenuItem", b =>
                {
                    b.HasOne("foodOrderingApp.models.Category", "Categories")
                        .WithMany()
