...
namespace foodOrderingApp.Migrations
{
    ...
    [Migration("20250520053145_cartitemsSchemaChanged")]
    partial class cartitemsSchemaChanged
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("foodOrderingApp.models.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("foodOrderingApp.models.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("foodOrderingApp.models.FirebaseTokensModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("foodOrderingApp.models.CartItem", b =>
                {
                    b.HasOne("foodOrderingApp.models.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("foodOrderingApp.models.MenuItem", "Item")
                        .WithMany()
